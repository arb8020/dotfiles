...
- **[style_reference.md](style_reference.md)** - **Start here if you want the most precise statement of this style.** Concrete "pick between two options and explain your reasoning" exercises. More honest than any generic guide.
...
**Frontend:** [frontend/](frontend/) — state machines, animations, polish, React patterns, design engineering, skills
...
- `other/frontend/` — (promoted to `frontend/` — originals kept for reference)
