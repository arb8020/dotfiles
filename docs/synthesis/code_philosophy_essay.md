...
# TODO: 
the above document mostly models LLMs as tasks/tools (to stay in a potential reader's overton window) when the underlying useful mindset this would try to get someone towards is LLM as collaborator/pair programmer. anytime you have trouble with a model you can simply honestly/kindly express the frustration or problem you're having, as you might to a human collaborator you enjoy working with or respect, and it might help
